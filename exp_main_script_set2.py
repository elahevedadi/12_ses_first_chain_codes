...
# 1
from exp_regression_with_PCA import prepare_12_ses_data
# 2
from exp_regression_with_PCA import reduced_number_of_voxels
# 3
from exp_regression_with_PCA import concatenate_func
# 4
from exp_regression_with_PCA import make_train_and_test_concat_data
# 4'
from exp_regression_with_PCA import dimensionality_reduction_version_1
# 4''
from exp_regression_with_PCA import dimensionality_reduction_version_2
# 5
from exp_regression_with_PCA import find_critical_times
# 6
from exp_regression_with_PCA import shift
# 7
from exp_regression_with_PCA  import test_train_check_func_concat_data
# 8
from exp_regression_with_PCA import find_mean_and_variance_of_theta
# 9
from exp_regression_with_PCA import plotting_results
# 10
from exp_regression_with_PCA import find_test_cost
# 11
from exp_regression_with_PCA import find_corresponding_voxel_after_reshape
# 12
from exp_regression_with_PCA import find_train_cost
# 13
...
number_of_principal_components = 3
...
if exp_regression == 1:
   ...
   for i in range(num_storing_sets_of_theta):
       ...
       theta_3, test_cost , test_cost_per_iter , train_cost , train_cost_per_iter , before_test_cost , before_train_cost = test_train_check_func_concat_data( x_train, x_test,
                                                                                                                                                                       z_train , z_test ,
                                                                                                                                                                       target_voxel_ind , alpha ,
                                                                                                                                                                       num_iter ,reduce_alpha_coef,
                                                                                                                                                                       critical_times_set,forget_factor
                                                                                                                                                                       ,training_at_random)
    
       my_theta[:,i] = theta_3[:,0]
