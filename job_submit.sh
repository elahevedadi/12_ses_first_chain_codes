#PBS -N Hesam_fMRI
#PBS -m ae
#PBS -M a.salavati@ictic.sharif.edu
#PBS -l nodes=1:ppn=4
...
python complete_main_script.py -M $inf_method -A $alph -F $session_inds -o $voxel_inds -X $num_iter -Y $num_storing_sets_of_theta -R $training_at_random -J $num_train_examp
